...
class MsmMainWindow(QMainWindow):
    def __init__(self):
        super(MsmMainWindow, self).__init__()
    ...
    def browse_image_files(self):
        # Open File Dialog
        self.image_file_name, _ = QFileDialog.getOpenFileName(
    ...
    def browse_instrument_files(self):
        # Open File Dialog
        self.instrument_file_name, _ = QFileDialog.getOpenFileName(
            self, "Open File", "", "All Files (*)"
        )
